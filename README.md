...
```powershell
cd $Env:USERPROFILE;
Invoke-WebRequest https://raw.githubusercontent.com/jchip/universal-nvm/v1.12.1/install.ps1 -OutFile install.ps1;
.\install.ps1;
del install.ps1
```
...
1. Download the package zip file from https://github.com/jchip/universal-nvm/archive/v1.12.1/.zip
   1. Extract this file to your home directory. You will get a new directory `universal-nvm-1.12.1`.
...
```bash
curl -o- https://raw.githubusercontent.com/jchip/universal-nvm/v1.12.1/install.sh | bash
```

or wget:

```bash
wget -qO- https://raw.githubusercontent.com/jchip/universal-nvm/v1.12.1/install.sh | bash
```
