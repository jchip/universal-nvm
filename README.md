...
```powershell
cd $Env:USERPROFILE;
Invoke-WebRequest https://raw.githubusercontent.com/jchip/universal-nvm/v1.12.0/install.ps1 -OutFile install.ps1;
.\install.ps1;
del install.ps1
```
...
1. Download the package zip file from https://github.com/jchip/universal-nvm/archive/v1.12.0/.zip
   1. Extract this file to your home directory. You will get a new directory `universal-nvm-1.12.0`.
   2. Rename it to `nvm`, for example: `C:\Users\<username>\nvm`
2. Download the zipfile https://nodejs.org/dist/v24.20.0/node-v24.20.0-win-x64.zip
   1. Extract this file to `C:\Users\<username>\nvm`. You will get a new directory `node-v24.20.0-win-x64`
...
```bash
curl -o- https://raw.githubusercontent.com/jchip/universal-nvm/v1.12.0/install.sh | bash
```

or wget:

```bash
wget -qO- https://raw.githubusercontent.com/jchip/universal-nvm/v1.12.0/install.sh | bash
```
